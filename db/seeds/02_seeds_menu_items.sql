INSERT INTO menu_items (name, food_description, price, item_url, type_of_item)
  ...
  ('Muffuletta Sandwich', 'Deli meats, cheese with olive spread', 800, ../../public/docs/food-images/Muffuletta.webp, 'sandwich'),
  ('Mini Italian Meatball Sliders', 'Cheesy meatballs, roasted peppers', 700, ../..//Users/rickywu/lighthouse/Food-Midterm/public/docs/food-images/Meatball-Sliders.webp, 'sandwich'),
  ('Porchetta Sandwich', 'Pork shoulder, rosemary, fennel and garlic', 900, ../../public/docs/food-images/Porchetta-Sandwich.webp, 'sandwich'),
  ('Meatball Grilled Cheese Sandwich', 'Meatball and cheese', 800, ../../public/docs/food-images/Meatball-Smash-Grilled-Cheese.webp, 'sandwich'),
  ('Tomato Basil Soup', 'Tomato and Basil', 500, ../../public/docs/food-images/Basil-Tomato.jpeg, 'soup'),
  ('Ravioli Phở Soup', 'Very hearty', 500, ../../public/docs/food-images/Ravioli-pho broth.jpeg, 'soup'),
  ('Meatball Phở Soup', 'Very hearty + Meatball', 500, ../../public/docs/food-images/Meatball-pho-soup.jpeg, 'soup'),
  ...
  ('Taro Bubble Tea', 'one size', 560, ../..public/docs/food-images/taro.jpeg, 'bubbletea'),
  ('Mango Bubble Tea', 'one size', 550, ../..public/docs/food-images/mango.jpeg, 'bubbletea'),
  ('Peach Bubble Tea', 'one size', 560, ../..public/docs/food-images/peach.png, 'bubbletea'),
  ('Durian Bubble Tea', 'one size', 700, ../..public/docs/food-images/durian.webp, 'bubbletea'),
  ('Lychee Bubble Tea', 'one size', 560, ../..public/docs/food-images/lychee.png, 'bubbletea'),
  ('Italian Sorbet', 'Apple, Berry, Melon, Coconut', 500, ../..public/docs/food-images/sorbet.jpeg, 'dessert'),
